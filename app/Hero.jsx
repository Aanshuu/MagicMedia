  ...
  return (
    <div className="flex flex-col px-10 py-5 items-center lg:justify-between lg:flex-row lg:px-20 lg:py-10">
      <div className="max-w-lg">
        <h1 className="text-3xl font-bold text-gray-800 mb-6 text-center lg:text-start lg:text-5xl">India's best digital marketing happens here.</h1>
        <div className="flex lg:hidden">
          <img src="/magichat.svg" alt="Magic Hat" className="w-full h-auto max-w-auto mx-auto" />
        </div>
        <p className="text-lg text-gray-700 text-center mt-6 lg:text-start">MagicMedia delivers growth outcomes through high-quality digital marketing services to enterprise companies, startups, and VC firms.</p>
