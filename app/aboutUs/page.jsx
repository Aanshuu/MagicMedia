    ...
    <div className="">
      ...
      <div className="relative text-center lg:text-left lg:flex lg:items-center lg:justify-between lg:-mt-24 lg:pl-16 lg:ml-2 ">
        <div className="absolute top-0 w-full lg:relative lg:w-1/2 z-10 p-4 lg:p-0 text-center">
          <h1 className="text-3xl lg:text-6xl mb-4 text-center flex-wrap lg:max-w-xl lg:text-start font-medium">
            We’re a dynamic team of innovative thinkers.
          </h1>
          <p className="mb-8 lg:max-w-sm lg:text-lg lg:text-start font-normal">
        ...
        <div className="lg:hidden lg:w-[48%] top-0 lg:mt-0 flex justify-center z-0 relative bg-[#F1C767]">
          <img src="/About_Us_Mobile.png" alt="Team Illustration" className="max-w-full h-auto mt-28"/>
        </div>
      ...
      <section className="px-4 py-8 lg:py-16 lg:px-16 lg:m-2">
        <h2 className="text-3xl text-left font-medium lg:text-6xl mb-5 lg:mb-0">Our Vision</h2>
        <div className="flex flex-col items-center justify-between">
          <div className="flex flex-col lg:flex-row items-center justify-between mb-8 w-full">
            <div className="order-1 lg:order-2 flex">
                <img src="/About_Us_vision.png" alt="Vision Illustration" className="w-full lg:max-w-sm lg:h-auto"/>
            </div>
            <div className="order-2 lg:order-1 flex flex-col lg:max-w-lg lg:justify-end lg:self-end lg:mr-10">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between lg:mt-10 w-full">
            <div className="order-1 flex">
              <img src="/About_Us_creative.png" alt="Creative Minds Illustration" className="w-full lg:max-w-sm lg:h-auto" />
            </div>
      ...
      <section className="px-4 py-8 lg:py-16 lg:px-24 text-center">
        ...
        <Link href="/contactUs">
          <button className="bg-gradient-to-r from-[#A01122] to-[#ECB54E] text-white py-2 px-4 rounded-lg lg:text-xl font-normal">
            Let's Talk
          </button>
        </Link>
      </section>
