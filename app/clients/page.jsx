    ...
    <div className="font-Poppins">
        ...
        <div className="relative text-center lg:text-left lg:flex lg:items-center lg:justify-between lg:-mt-24 lg:pl-16 lg:ml-2 ">
          ...
          <div className="lg:hidden lg:w-[48%] top-0 lg:mt-0 flex justify-center z-0 relative bg-[#F1DAA7]">
            <img src="/Clients_handshake.png" alt="Team Illustration" className="max-w-full h-auto  mt-44"/>
          </div>
      ...
      <div className="py-8 sm:py-16">
        <h2 className="text-center font-bold text-3xl font-Poppins-400 lg:text-6xl">You're joining a league of trailblazers.</h2>
      ...
      <div className="py-8 sm:py-16 text-center">
        <h2 className="font-bold text-3xl lg:text-6xl font-Poppins-400">Like What We Do?</h2>
        <button className="mt-6 px-6 py-2 bg-gradient-to-r from-[#A01122] to-[#ECB54E] text-white font-semibold rounded-lg">Let's Talk</button>
      </div>
    </div>
  );
}
