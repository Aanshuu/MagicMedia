        ...
        <div className="order-1 lg:order-2 w-full lg:w-[48%] p-4 bg-[#F1C767] lg:min-h-screen min-h-[46%] flex justify-center items-center -mr-16 overflow-hidden">
          <div className="flex justify-center items-center gap-10">
            ...
            <div className="w-full lg:p-24 lg:pt-40 overflow-hidden">
              <img src="/Advertising_Infra.svg" alt="OOH Marketing" className="object-cover w-full h-auto max-w-full max-h-full"/>
              <p className="text-center mt-6 lg:text-3xl text-xl font-medium text-white flex-nowrap tracking-[0.15em]">ADVERTISING INFRA</p>
            </div>
