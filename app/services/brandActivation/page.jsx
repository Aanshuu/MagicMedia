    ...
    <div className="overflow-hidden min-h-screen relative">
      ...
      <div className="h-screen flex flex-col lg:flex-row lg:justify-between items-start lg:items-center lg:p-14 lg:-mt-24 z-0">
        ...
        <div className="order-1 lg:order-2 w-full lg:w-[48%] p-4 bg-[#F1C767] lg:min-h-screen min-h-[46%] flex justify-center items-center -mr-16 overflow-hidden">
          <div className="flex justify-center items-center gap-10">
            ...
            <div className="w-full lg:p-24 lg:pt-40 -mt-4 overflow-hidden">
              <img src="/Brand_Activation.png" alt="OOH Marketing" className="object-cover w-full h-auto max-w-full max-h-full" />
              <p className="text-center lg:text-3xl text-xl font-medium text-white tracking-widest flex-nowrap -mt-10">BRAND ACTIVATION</p>
            </div>
        ...
        <div className="order-2 lg:order-1 w-full lg:w-3/5 p-4 max-w-xl">
          ...
          <h1 className="text-3xl lg:text-6xl mb-2.5 lg:mb-3 font-medium flex-wrap">Brand Activation</h1>
