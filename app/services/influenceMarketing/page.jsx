  ...
  return (
    <div className="overflow-hidden min-h-screen relative">
      ...
      <div className="h-screen flex flex-col lg:flex-row lg:justify-between items-start lg:items-center lg:p-14 lg:-mt-24 z-0">
        {/* Image Portion */}
        <div className="order-1 lg:order-2 w-full lg:w-[48%] p-4 bg-[#F1C767] lg:min-h-screen flex justify-center items-center -mr-16">
          <div className="flex justify-center items-center gap-10">
            ...
            <div className="w-full lg:p-24 lg:pt-40 ">
              <img src="/Influencer_Marketing.png" alt="OOH Marketing" className="object-cover" />
              <p className="text-center mt-6 lg:text-3xl text-xl font-Poppins-500 text-white tracking-widest flex-nowrap">INFLUENCER MARKETING</p>
            </div>
        ...
        <div className="order-2 lg:order-1 w-full lg:w-3/5 p-4 max-w-xl">
          ...
          <h1 className="text-3xl lg:text-6xl mb-2.5 lg:mb-3 font-Poppins-600 flex-wrap">Influencer Marketing</h1>
          <h1 className="text-xl lg:text-2xl mb-4 lg:mb-7 font-Poppins-400">Amplify your Brand with Influencers</h1>
          <p className="text-lg lg:text-2xl mb-2.5 lg:mb-6 font-Poppins-400 flex-wrap text-[#000000B2] lg:text-black">Leverage influencer partnerships to expand and strengthen your brand's message.</p>
